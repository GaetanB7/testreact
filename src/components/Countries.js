    ...
    return (
        ...
        <div className='countries'>
            ...
            <ul className="radio-container">
                ...
                <li>
                    <input type="radio" name="" id={continent} name="continentRadio" checked={continent === selectedRadio} onChange={(e) => setSelectedRadio(e.target.id)}/>
